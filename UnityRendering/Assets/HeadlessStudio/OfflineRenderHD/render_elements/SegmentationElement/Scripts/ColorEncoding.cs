/*
 * Code from Unity Machine Learning Synthesis
 * https://bitbucket.org/Unity-Technologies/ml-imagesynthesis/src/master/Assets/ImageSynthesis/ImageSynthesis.cs
*/
using UnityEngine;
